...
/*
class TextMessageItemR: MessageItemAdapter() {
    override fun onCreateView(context: Context): View {
        return LayoutInflater.from(context).inflate(R.layout.item_text_r, null)
    }
    ...
    override fun isItemType(messageType: Int, originType: Int): Boolean {
        return messageType == UIMessage.TYPE_TEXT && originType == UIMessage.ORIGIN_TYPE_SENDING
    }
}*/
